...
export default function ClientSignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store client data in sessionStorage (for backward compatibility)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl border-0 border-blue-200">
        <CardHeader className="space-y-1 text-center pb-8">
          ...
          <CardTitle className="text-3xl font-bold text-blue-900">Client Sign In</CardTitle>
        ...
        <form onSubmit={handleSignIn}>
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/client/forgot-password" className="text-blue-600 hover:text-blue-800 font-medium">
                Forgot password?
              </Link>
            </div>
          </CardContent>
